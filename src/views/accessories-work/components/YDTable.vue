...
const columns: TableColumnType<any>[] = [
    { title: 'ID', dataIndex: 'id', width: '80px', sorter: (a, b) => Number(a.id ?? 0) - Number(b.id ?? 0) },
    { title: '产品名', dataIndex: 'productName', width: '180px' },
    { title: '款式', dataIndex: 'style', width: '120px' },
    { title: '颜色', dataIndex: 'color', width: '100px' },
    { title: '实际材质', dataIndex: 'actualMaterial', width: '140px' },
    { title: '内衬材质', dataIndex: 'liningMaterial', width: '140px' },
    { title: '洗标种类', dataIndex: 'washlabelType', width: '140px' },
    { title: '数量', dataIndex: 'quantity', width: '100px' },
    { title: '实际出货数量', dataIndex: 'actualShipQuantity', width: '130px' },
    { title: '单价', dataIndex: 'unitPrice', width: '100px' },
    { title: '总价', dataIndex: 'totalPrice', width: '120px' },
    { title: '地址', dataIndex: 'address', width: '200px' },
    { title: '跟单', dataIndex: 'follower', width: '120px' },
    ...
    { title: '创建时间', dataIndex: 'createdAt', width: '200px', sorter: (a: any, b: any) => (new Date(a.createdAt ?? '').getTime() || 0) - (new Date(b.createdAt ?? '').getTime() || 0), customRender: ({ text }) => formatTime(text) },
    { title: '修改时间', dataIndex: 'updatedAt', width: '200px', sorter: (a: any, b: any) => (new Date(a.updatedAt ?? '').getTime() || 0) - (new Date(b.updatedAt ?? '').getTime() || 0), customRender: ({ text }) => formatTime(text) },
    { title: '备注', dataIndex: 'remark', width: '220px' },
    { title: '优先级', dataIndex: 'priority', width: '120px' },
    { title: '扩展字段', dataIndex: 'extraJson', width: '120px' },
