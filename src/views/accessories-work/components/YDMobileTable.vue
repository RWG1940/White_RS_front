            ...
            <div class="status-badges">
              <div
                :style="{
                  borderRadius: '15px',
                  backgroundColor:
                    item.washPriority == 2 ? 'red' : item.washPriority == 0 ? 'lightgreen' : 'gold',
                  width: '12px',
                  height: '12px',
              ...
              <div
                :style="{
                  borderRadius: '15px',
                  backgroundColor:
                    item.tagPriority == 2 ? 'red' : item.tagPriority == 0 ? 'lightgreen' : 'gold',
                  width: '12px',
                  height: '12px',
          ...
          <a-col :span="6">
            <div class="edit-button">
              <a-button
                ...
                danger
                style="width: 100%"
                @click.stop="deleteItem(item.id as number)"
                ><DeleteOutlined />
              </a-button>
            </div>
          </a-col>
        ...
        <div class="detail-section">
            ...
            <div class="detail-content">
              <div
                :style="{
                  borderRadius: '15px',
                  backgroundColor:
                    selectedItem.washPriority == 2
                      ? 'red'
                      : selectedItem.washPriority == 0
                        ? 'lightgreen'
                        : 'gold',
                  width: '20px',
                  height: '20px',
          ...
          <div class="detail-item">
            ...
            <div class="detail-content">
              <a-tag
                :color="
                  selectedItem.washStatus == 0
                    ? 'lightgrey'
                    : selectedItem.washStatus == 1
                      ? 'orange'
                      : selectedItem.washStatus == 2
                        ? 'pink'
                        : selectedItem.washStatus == 3
                          ? 'green'
                          : ''
                "
              >
            ...
            <div class="detail-content">
              <div
                :style="{
                  borderRadius: '15px',
                  backgroundColor:
                    selectedItem.tagPriority == 2
                      ? 'red'
                      : selectedItem.tagPriority == 0
                        ? 'lightgreen'
                        : 'gold',
                  width: '20px',
                  height: '20px',
          ...
          <div class="detail-item">
            ...
            <div class="detail-content">
              <a-tag
                :color="
                  selectedItem.tagStatus == 0
                    ? 'lightgrey'
                    : selectedItem.tagStatus == 1
                      ? 'orange'
                      : selectedItem.tagStatus == 2
                        ? 'pink'
                        : selectedItem.tagStatus == 3
                          ? 'green'
                          : ''
                "
              >
